          ...
          <Show when="signed-in">
            <div className="flex items-center gap-2.5">
              {currentUser?.role === "ADMIN" ? (
                <Link
                  href="/admin"
                  className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-purple-100 text-purple-800 border border-purple-300 hover:bg-purple-200 transition shadow-xs cursor-pointer"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 pt-3 pb-5 space-y-1 animate-slide-up">
          ...
          <Link
            ...
            className="flex items-center justify-between px-3 py-2.5 rounded-xl text-sm font-semibold text-purple-700 bg-purple-50 hover:bg-purple-100 transition"
          >
